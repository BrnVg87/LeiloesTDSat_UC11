...
public class vendasVIEW extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        listaProdutosVendidos.setModel(montarTabela());
...
/*    private int getPosicao() {
        int posicao = listaProdutosVendidos.getSelectedRow();
        if(posicao <= -1) {
            JOptionPane.showMessageDialog(null, "Selecione um item.");
        }     
        return Integer.parseInt( (String) listaProdutosVendidos.getValueAt(posicao, 0) );
    } */
